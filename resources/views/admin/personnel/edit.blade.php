...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        ...
        <p class="text-secondary mb-0">{{ $personnel->ad_soyad }} - Personel bilgilerini güncelleyin</p>
    </div>
    <div class="d-flex gap-2">
        <a href="{{ route('admin.personnel.show', $personnel) }}" class="btn btn-primary d-inline-flex align-items-center gap-2">
...
<form action="{{ route('admin.personnel.update', $personnel) }}" method="POST" id="personnel-edit-form" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="row g-4">
        {{-- Sol sütun: Form --}}
        <div class="col-lg-7">
            @include('admin.personnel._header', ['personnel' => $personnel, 'editable' => true])

            {{-- Form kartları --}}
            <div class="bg-white rounded-3xl shadow-sm border p-4" style="border-color: var(--bs-primary-200);">
                @include('admin.personnel._form', ['personnel' => $personnel])
        ...
        <div class="col-lg-5">
            ...
            <div class="personel-preview-card border rounded-3 p-4 bg-white shadow-sm mb-4" style="border-color: var(--bs-primary-200) !important;">
                ...
                @include('admin.personnel._id_card', ['personnel' => $personnel, 'live' => true])

                <div class="rounded-3 p-3 border bg-white" style="border-color: var(--bs-primary-200) !important;">
            ...
            <div class="border rounded-3 p-4 bg-white shadow-sm mb-4" style="border-color: var(--bs-primary-200) !important;">
                ...
                <div class="d-flex flex-column gap-2">
                    <a href="{{ route('admin.personnel.show', $personnel) }}" class="btn btn-outline-primary d-inline-flex align-items-center justify-content-center gap-2">
