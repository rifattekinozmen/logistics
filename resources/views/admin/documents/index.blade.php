        ...
        <table class="table table-hover mb-0">
            <thead class="bg-primary-200">
                <tr>
                    ...
                    <th class="border-0 fw-semibold text-secondary small">
                        @php $direction = $currentSort === 'documentable_type' && $currentDirection === 'asc' ? 'desc' : 'asc'; @endphp
                        <a href="{{ route('admin.documents.index', array_merge(request()->query(), ['sort' => 'documentable_type', 'direction' => $direction])) }}" class="d-inline-flex align-items-center gap-1 text-secondary text-decoration-none">
                            <span>Bağlı Olduğu</span>
                            @if($currentSort === 'documentable_type')
