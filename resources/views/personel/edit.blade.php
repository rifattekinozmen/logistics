...
<div class="personel-portal-wrap">
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div>
            ...
            <p class="text-secondary mb-0 small">Resmi kimlik bilgilerini ve iş bilgilerini güncelleyiniz.</p>
        </div>
    ...
    <form action="{{ route('personel.update', $personel->id) }}" method="POST" id="personel-form">
        @csrf
        @method('PUT')
                ...
                <div class="personel-form-card">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="tckn" id="tckn" value="{{ old('tckn', $personel->tckn) }}" class="form-control rounded-3 border-primary-200 @error('tckn') is-invalid border-danger @enderror" placeholder="00000000000" maxlength="11" pattern="[0-9]*" inputmode="numeric">
                            @error('tckn')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="kimlik_seri_no" id="kimlik_seri_no" value="{{ old('kimlik_seri_no', $personel->kimlik_seri_no) }}" class="form-control rounded-3 border-primary-200 @error('kimlik_seri_no') is-invalid border-danger @enderror" placeholder="A01-XXXXXX">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="ad_soyad" id="ad_soyad" value="{{ old('ad_soyad', $personel->ad_soyad) }}" class="form-control rounded-3 border-primary-200 @error('ad_soyad') is-invalid border-danger @enderror" placeholder="Adınız Soyadınız" required>
                            @error('ad_soyad')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-12">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email', $personel->email) }}" class="form-control rounded-3 border-primary-200 @error('email') is-invalid border-danger @enderror" placeholder="ornek@firma.com" required>
                            @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="telefon" id="telefon" value="{{ old('telefon', $personel->telefon) }}" class="form-control rounded-3 border-primary-200 @error('telefon') is-invalid border-danger @enderror" placeholder="5XX XXX XX XX">
                            @error('telefon')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="mobil_telefon" id="mobil_telefon" value="{{ old('mobil_telefon', $personel->mobil_telefon) }}" class="form-control rounded-3 border-primary-200 @error('mobil_telefon') is-invalid border-danger @enderror" placeholder="5XX XXX XX XX">
                            @error('mobil_telefon')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-12">
                            ...
                            <input type="text" name="acil_iletisim" id="acil_iletisim" value="{{ old('acil_iletisim', $personel->acil_iletisim) }}" class="form-control rounded-3 border-primary-200 @error('acil_iletisim') is-invalid border-danger @enderror" placeholder="Acil durumda aranacak numara">
                            @error('acil_iletisim')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="personel-form-card mt-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="anne_adi" id="anne_adi" value="{{ old('anne_adi', $personel->anne_adi) }}" class="form-control rounded-3 border-primary-200 @error('anne_adi') is-invalid border-danger @enderror" placeholder="Anne adı">
                            @error('anne_adi')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="baba_adi" id="baba_adi" value="{{ old('baba_adi', $personel->baba_adi) }}" class="form-control rounded-3 border-primary-200 @error('baba_adi') is-invalid border-danger @enderror" placeholder="Baba adı">
                            @error('baba_adi')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="date" name="dogum_tarihi" id="dogum_tarihi" value="{{ old('dogum_tarihi', $personel->dogum_tarihi?->format('Y-m-d')) }}" class="form-control rounded-3 border-primary-200 @error('dogum_tarihi') is-invalid border-danger @enderror">
                            @error('dogum_tarihi')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="dogum_yeri" id="dogum_yeri" value="{{ old('dogum_yeri', $personel->dogum_yeri) }}" class="form-control rounded-3 border-primary-200 @error('dogum_yeri') is-invalid border-danger @enderror" placeholder="İl / ilçe">
                            @error('dogum_yeri')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-12">
                            ...
                            <select name="medeni_durum" id="medeni_durum" class="form-select rounded-3 border-primary-200 @error('medeni_durum') is-invalid border-danger @enderror">
                                ...
                                <option value="Bekar" {{ old('medeni_durum', $personel->medeni_durum) === 'Bekar' ? 'selected' : '' }}>Bekar</option>
                                <option value="Evli" {{ old('medeni_durum', $personel->medeni_durum) === 'Evli' ? 'selected' : '' }}>Evli</option>
                                <option value="Dul" {{ old('medeni_durum', $personel->medeni_durum) === 'Dul' ? 'selected' : '' }}>Dul</option>
                                <option value="Boşanmış" {{ old('medeni_durum', $personel->medeni_durum) === 'Boşanmış' ? 'selected' : '' }}>Boşanmış</option>
                            </select>
                            @error('medeni_durum')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="personel-form-card mt-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="departman" id="departman" value="{{ old('departman', $personel->departman) }}" class="form-control rounded-3 border-primary-200 @error('departman') is-invalid border-danger @enderror" placeholder="Örn. Lojistik" required>
                            @error('departman')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="pozisyon" id="pozisyon" value="{{ old('pozisyon', $personel->pozisyon) }}" class="form-control rounded-3 border-primary-200 @error('pozisyon') is-invalid border-danger @enderror" placeholder="Örn. Sürücü" required>
                            @error('pozisyon')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="date" name="ise_baslama_tarihi" id="ise_baslama_tarihi" value="{{ old('ise_baslama_tarihi', $personel->ise_baslama_tarihi?->format('Y-m-d')) }}" class="form-control rounded-3 border-primary-200 @error('ise_baslama_tarihi') is-invalid border-danger @enderror" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="maas" id="maas" value="{{ old('maas', $personel->maas) }}" step="0.01" min="0" class="form-control rounded-3 border-primary-200 @error('maas') is-invalid border-danger @enderror" placeholder="0,00">
                            @error('maas')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
