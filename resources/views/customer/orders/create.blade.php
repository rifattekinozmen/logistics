...
<div class="bg-white rounded-3xl shadow-sm border p-4">
    <form action="{{ route('customer.orders.store') }}" method="POST">
        ...
        <div class="row g-3">
            <div class="col-md-12">
                <label for="pickup_address" class="form-label fw-semibold text-dark">Alış Adresi</label>
            ...
            <div class="col-md-12">
                <label for="delivery_address" class="form-label fw-semibold text-dark">Teslimat Adresi</label>
