<nav class="glass-card border-bottom px-4 py-3 sticky-top bg-primary-200" style="z-index: 999; background: linear-gradient(135deg, rgba(232, 235, 255, 0.9), rgba(255, 255, 255, 0.95)) !important;">
    <div class="d-flex align-items-center justify-content-between">
        ...
        <button class="btn btn-link text-secondary d-lg-none p-2 me-3 rounded-circle transition-all navbar-btn-hover" type="button" id="sidebarToggle">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            @endphp
            <div class="dropdown">
                <button class="btn btn-link text-secondary p-2 rounded-3xl transition-all d-flex align-items-center gap-2 navbar-btn-hover" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-3xl p-2 bg-white" style="min-width: 250px;">
                    ...
                    @endphp
                    <li>
                        <a class="dropdown-item d-flex align-items-center gap-3 p-3 rounded-2xl transition-all bg-primary-50 dropdown-item-hover" href="{{ $settingsUrl }}" target="_self">
                    ...
                    <li>
                        ...
                        <form action="{{ route('admin.companies.switch') }}" method="POST" class="company-switch-form">
                            ...
                            <button type="submit" class="dropdown-item d-flex align-items-center gap-3 p-3 rounded-2xl transition-all w-100 dropdown-item-hover {{ $activeCompany && $company->id === $activeCompany->id ? 'bg-primary-200' : '' }}">
                        @else
            ...
            <!-- Notifications -->
            <div class="dropdown">
                <button class="btn btn-link text-secondary p-2 rounded-circle position-relative transition-all navbar-btn-hover" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-3xl p-2 bg-white" style="min-width: 300px;">
                    ...
                    <li><hr class="dropdown-divider"></li>
                    <li>
                        <a class="dropdown-item d-flex align-items-start gap-3 p-3 rounded-2xl transition-all dropdown-item-hover" href="#">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-start gap-3 p-3 rounded-2xl transition-all dropdown-item-hover-success" href="#">
                    ...
                    <li><hr class="dropdown-divider"></li>
                    <li>
                        <a class="dropdown-item text-center text-primary fw-semibold rounded-2xl transition-all dropdown-item-hover" href="#">Tümünü Gör</a>
                    </li>
                </ul>
            </div>
            ...
            <!-- User Menu -->
            <div class="dropdown">
                <button class="btn btn-link text-secondary p-0 transition-all navbar-user-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    @if(Auth::user()->avatar)
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-3xl p-2 bg-white" style="min-width: 200px;">
                    ...
                    <li><hr class="dropdown-divider"></li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center gap-2 rounded-2xl transition-all dropdown-item-hover" href="{{ route('admin.profile.show') }}">
                            <span class="material-symbols-outlined">person</span>
                            <span>Profil</span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center gap-2 rounded-2xl transition-all dropdown-item-hover" href="{{ route('admin.settings.show') }}">
                    ...
                    <li>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="dropdown-item d-flex align-items-center gap-2 rounded-2xl text-danger transition-all w-100 dropdown-item-hover-danger">
